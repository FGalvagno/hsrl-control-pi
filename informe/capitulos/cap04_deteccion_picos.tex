...
La resistencia $R_3$ limita la corriente pico impulsiva provista por el transistor. Considerando una corriente máxima admisible $I_{C,\text{pico}} = 1\,\text{A}$ ante pulsos cortos, se tiene:
