...
%
% Documento maestro. Compilar con pdflatex + biber:
%   pdflatex main.tex
%   biber main
%   pdflatex main.tex
%   pdflatex main.tex
...
\titlespacing*{\section}{0pt}{1.5\baselineskip}{3\baselineskip}

\titleformat{\subsection}
  {\normalfont\fontsize{12}{14}\selectfont}{\thesubsection}{1em}{}
\titlespacing*{\subsection}{0pt}{1\baselineskip}{1.5\baselineskip}
...
\printbibliography[type=book,title={Bibliograf\'ia},heading=none]
...
% -------------------------------------------------------------
% ANEXO DE LA CATEDRA PI (SAT e Informes Mensuales)
% -------------------------------------------------------------
\backmatter
\cleardoublepage
\phantomsection
