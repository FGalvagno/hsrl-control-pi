...
\input{preliminares/lista_simbolos_v2}
...
\input{capitulos/cap04_deteccion_picos}
\input{capitulos/cap05_microcontrolador}
\input{capitulos/cap06_placa_control}
\input{capitulos/cap07_firmware}
\input{capitulos/cap08_software_hmi}
\input{capitulos/cap09_modeloexp}
...
% -------------------------------------------------------------
% El titulo se compone con \chapter*, igual que Resultados y Conclusiones, de
% modo que herede el formato de titulo definido con titlesec. Por eso ambos
% \printbibliography se declaran con heading=none.
\cleardoublepage
...
\input{anexos/anexo1_codigo_nies}
\input{anexos/anexo2_esquematico}
\input{anexos/anexo3_pcb}
\input{anexos/anexo4_hojas_datos}
\input{anexos/anexo5_codigo}
\input{anexos/anexo6_ilrc32}
