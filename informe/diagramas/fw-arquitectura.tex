...
\node[bloqueg,text width=25mm] (gen) at (0,3.2) {Laser\\host};
\node[bloqueg,text width=25mm] (det) at (0,1.0) {Detector HSRL\\canales $P_+$ / $P_-$};
...
\node[bloqueg,text width=26mm] (lvl)  at (11.0,0.3) {Conversor\\3,3V\,/\,RS-232};
