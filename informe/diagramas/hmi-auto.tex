% Figura: hmi-auto -- requiere \input{diagramas/estilos-diagramas} en el preambulo
...
\node[bloque,text width=48mm]  (a3) at (0,-3.6)
  {$t \leftarrow \dfrac{t_{\min p^{+}} + t_{\min p^{-}}}{2}$};
...
\node[nota,text width=62mm,anchor=north west] at (3.6,-12.6)
 {\textbf{Cancelación.} En cualquier punto, un comando de \texttt{INTERRUPTING\_COMMANDS}
  ...
  modo o la caída del puerto cancelan la secuencia. No se revierte lo ya enviado:
  el Pico queda en el último modo que recibió.};

\node[et,anchor=north west,align=left] at (-9.7,-9.2)
 {\scriptsize En las tres salidas de rechazo\\no se envía ningún comando al firmware.};
