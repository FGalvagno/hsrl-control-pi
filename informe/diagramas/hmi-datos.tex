% Figura: hmi-datos -- requiere \input{diagramas/estilos-diagramas} en el preambulo
...
\begin{scope}[on background layer]
  \fill[banda] (-9.6,-9.4) rectangle (11.0,2.3);
  \fill[banda] (-9.6,-33.4) rectangle (11.0,-12.4);
\end{scope}
\node[tit,anchor=north west] at (-9.5,2.2)   {hilo lector \textemdash\ \texttt{serie.py}, continuo};
...
\draw[canal] (aw.north) -- (6.4,0.9) -- (0,0.9);
\draw[canal] (a3.west) -- node[et,above,pos=0.25]{no} (-9.1,-4.8) -- (-9.1,0.9) -- (0,0.9);
\draw[flecha] (0,0.9) -- (a1.north);
...
\node[dec]  (b7) at (0,-31.2) {¿hubo\\novedades?};

\node[bloquer,text width=34mm] (bd) at (6.6,-29.0) {Avisar y cerrar el puerto};
\node[bloque,text width=34mm]  (br) at (6.6,-31.2) {\texttt{\_refresh\_display()}};
...
\draw[flechag] (bd.south) -- (6.6,-30.1) -- (0,-30.1);
\draw[flechag] (br.south) -- (6.6,-32.5) -- (0,-32.5);
\draw[flecha] (b7.south) -- node[et,left,pos=0.4]{no} (0,-32.5) -- (10.3,-32.5)
