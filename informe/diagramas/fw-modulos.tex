% Figura: fw-modulos -- requiere \input{diagramas/estilos-diagramas} en el preambulo
...
\node[et,align=left,anchor=north west] at (-6.4,-2.3)
  {\scriptsize $\longrightarrow$ dependencia de compilación (\texttt{\#include})};
